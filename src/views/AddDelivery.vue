          ...
          <v-form>
            <v-container py-0>
              <v-layout wrap>
                ...
                <v-flex xs12 md6>
                  <v-text-field v-model="source" class="purple-input" label="Source" />
                </v-flex>
                <v-flex xs12 md4>
                ...
                <v-flex xs12 md4>
                  <v-text-field v-model="price" label="Price" class="purple-input" :rules="requiredRules" />
                </v-flex>
                <v-flex xs12 md4>
...
export default {
  ...
  methods: {
    add_delivery() {
      ...
      var data = { supplier: this.supplier, source: this.source, amount: parseFloat(this.amount), price: parseFloat(this.price), comments: this.comments }
      console.log(data)
